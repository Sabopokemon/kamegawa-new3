...
const activities = [
    ...
    descriptionEn: 'A fishing boat cruise along the Kamegawa coast was organized as a special experience event in cooperation with local fishermen, held during the Kamegawa Summer Festival. Participants enjoyed viewing fireworks launched from Kamegawa Port, guided by local fishermen on their boats. Watching Kamegawa'},
  {
    ...
    descriptionJa: '亀川プロジェクトでは、地域の住民や自治会からの要望や困りごとに対応する「お困りごと解決」活動も行っています。この活動は、地域住民が日常的に抱える課題や要望に対し、学生が主体的に支援を行う取り組みです。この「お困りごと解決」活動は、地域住民にとっても学生にとっても意義深い交流の場であり、地域社会への貢献と学生の成長を促す貴重な機会となっています。',
    descriptionEn: 'The Kamegawa Project conducts "Problem-Solving Support" activities to address requests and concerns from local residents and community associations. This initiative involves students actively supporting the daily challenges and needs of community residents. These "Problem-Solving Support" activities serve as meaningful interactions for both residents and students, providing valuable opportunities for community contribution and student growth.'
  }
];
